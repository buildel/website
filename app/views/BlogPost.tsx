  ...
  return (
    ...
    >
      <p className="lead">
        ...
        past few weeks we've been working very hard to polish the app enough to
        release the new features and we're excited to share with you some of the
      ...
      <h3>Browser Tool</h3>
      <p>
        Your Buildel workflows will now be able to read any webpage you want. If
        you ever need to extract data from a website, this block will be perfect
        for you.
      </p>
      ...
      <p>
        ...
        URL parse it for you and return in a text form. You can later input this
        text into another block like a Chat or TextOutput.
      </p>
      <h4>Give tool access to it to your chat block</h4>
      <Video src="/assets/posts/browser-llm.webm" />
      <p>
        You can attach the browser tool through the I/O interface to chat block.
        It can then call the tool by itself and do whatever is needed with the
        data: summarize it, extract data etc.
      </p>
      <h4>Use in chat</h4>
      <p>
      ...
      <p>
        ...
        knowledge base for later usage. This combination of tools will give you
        the ability to scrape any website and later use multiple of those for
        your workflows.
      </p>
      <blockquote>
      ...
      <p>
        ...
        Chat block access to it. It supports multiple tables at the same time so
        don't be afraid to challenge the LLM.
      </p>
      <p>
      ...
      <p>
        To do that you have to create a FileInput, attach it to a tool you wish
        the file should send the file ie. DocumentTool or the new CSV Search
      </p>
      <p>
        After that in the interface Chat select the file input you wish the chat
        should be attached to and use the files directly!
      </p>
      <Video src="/assets/posts/file_input.mp4" />
      <h2>Other things...</h2>
      <p>
        Besides that we've fixed multiple bugs, added file inputs to multiple
        blocks, introduced a possibility to send files through initial_inputs in
        API, added support for tables importing in CSV, XLS, Docs and PDF files.
